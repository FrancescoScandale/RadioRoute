...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b75458, const void *arg_0xb7b755f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b268c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79d0840), 
int (*key_eq_fn)(void *arg_0xb79d0c88, void *arg_0xb79d0e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb789f9b8, int arg_0xb789fb10);
static double RandomUniform(void );
...
typedef nx_struct routing_table_entry {
  ...
  nx_uint16_t cost;
} __attribute__((packed)) routing_table_entry;
...
routing_table_entry RadioRouteC$routing_table[1000][7];
uint16_t RadioRouteC$destination[1000];
uint32_t RadioRouteC$person_code[1000];
uint32_t RadioRouteC$j[1000];
...
#line 184
    {
      ...
      if (RadioRouteC$person_code[sim_node()] == 0) {
          for (RadioRouteC$j[sim_node()] = 1; RadioRouteC$j[sim_node()] <= 10616610; RadioRouteC$j[sim_node()] *= 10) ;
          RadioRouteC$person_code[sim_node()] = 10616610;
        }
      RadioRouteC$j[sim_node()] = RadioRouteC$j[sim_node()] / 10;


      switch (RadioRouteC$person_code[sim_node()] / RadioRouteC$j[sim_node()] % 3) {
          case 0: 
      ...
      sim_log_debug(156U, "radio", "Led status: %u%u%u - Message type: %d\n", RadioRouteC$Leds$get() & LEDS_LED0, (RadioRouteC$Leds$get() & LEDS_LED1) / 2, (RadioRouteC$Leds$get() & LEDS_LED2) / 4, __nesc_ntoh_uint8(received_msg->type.nxdata));


      RadioRouteC$person_code[sim_node()] %= RadioRouteC$j[sim_node()];


      sim_log_debug(157U, "radio_pack", "\t Payload length %hhu \n", RadioRouteC$Packet$payloadLength(bufPtr));

      switch (__nesc_ntoh_uint8(received_msg->type.nxdata)) {
          case 0: 
            sim_log_debug_clear(158U, "radio_pack", "\t\t   Payload - node %d\n", TOS_NODE_ID);
          sim_log_debug_clear(159U, "radio_pack", "\t\t   msg_type: DATA\t msg_src: %hu\t msg_dst: %hu\t msg_value: %hu \n", __nesc_ntoh_uint16(received_msg->src.nxdata), __nesc_ntoh_uint16(received_msg->dst.nxdata), __nesc_ntoh_uint16(received_msg->value.nxdata));
          found = FALSE;
          for (i = 0; i < 7; i++) {
              if (__nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][i].dst.nxdata) == RadioRouteC$destination[sim_node()]) {
                  found = TRUE;
                  break;
                }
              else {
#line 228
                if (__nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][i].cost.nxdata) == 0) {
#line 228
                  break;
                  }
                }
          ...
          if (found) {
              if (RadioRouteC$locked[sim_node()]) {
                  ...
                  msg = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
                  if (msg == (void *)0) {
                      return bufPtr;
                    }
                  __nesc_hton_uint8(msg->type.nxdata, 0);
                  __nesc_hton_uint16(msg->src.nxdata, TOS_NODE_ID);
                  __nesc_hton_uint16(msg->dst.nxdata, __nesc_ntoh_uint16(received_msg->dst.nxdata));
                  __nesc_hton_uint16(msg->value.nxdata, __nesc_ntoh_uint16(received_msg->value.nxdata));
                  if (RadioRouteC$generate_send(__nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][i].next_hop.nxdata), &RadioRouteC$packet[sim_node()], __nesc_ntoh_uint8(msg->type.nxdata)) == TRUE) {
                    }
                  else 
#line 246
                    {
                      sim_log_debug(160U, "radio_send", "Send is already being generated, cancelling this one.\n");
                    }
                }
            }
          else {
#line 250
            if (TOS_NODE_ID == __nesc_ntoh_uint16(received_msg->dst.nxdata)) {
                sim_log_debug(161U, "radio", "Data arrived ad destination! Data: %hu\n", __nesc_ntoh_uint16(received_msg->value.nxdata));
              }
            else {
                sim_log_debug(162U, "radio", "Can't send to the next node: I don't have the destination in my routing table!\n");
              }
            }
          break;
          ...
          sim_log_debug_clear(164U, "radio_pack", "\t\t   msg_type: ROUTE_REQ\t msg_dst: %hu\t\n", __nesc_ntoh_uint16(received_msg->dst.nxdata));


          if (TOS_NODE_ID == __nesc_ntoh_uint16(received_msg->dst.nxdata)) {
              if (RadioRouteC$locked[sim_node()] || RadioRouteC$route_rep_sent[sim_node()]) {
                  return bufPtr;
                }
              else {
                  msg = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
                  ...
                  __nesc_hton_uint16(msg->src.nxdata, TOS_NODE_ID);
                  __nesc_hton_uint16(msg->dst.nxdata, __nesc_ntoh_uint16(received_msg->dst.nxdata));
                  __nesc_hton_uint16(msg->value.nxdata, 1);
                  if (RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], __nesc_ntoh_uint8(msg->type.nxdata)) == TRUE) {
                    }
                  else 
#line 278
                    {
                      sim_log_debug(165U, "radio_send", "Send is already being generated, cancelling this one.\n");
                    }
                }
            }
          else 
...
#line 289
              ...
              if (found) {
                  if (RadioRouteC$locked[sim_node()] || RadioRouteC$route_req_sent[sim_node()]) {
                      return bufPtr;
                    }
                  else {
                      msg = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
                      ...
                      __nesc_hton_uint16(msg->src.nxdata, TOS_NODE_ID);
                      __nesc_hton_uint16(msg->dst.nxdata, __nesc_ntoh_uint16(received_msg->dst.nxdata));
                      __nesc_hton_uint16(msg->value.nxdata, __nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][i].cost.nxdata) + 1);
                      if (RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], __nesc_ntoh_uint8(msg->type.nxdata)) == TRUE) {
                        }
                      else 
#line 307
                        {
                          sim_log_debug(166U, "radio_send", "Send is already being generated, cancelling this one.\n");
                        }
                    }
                }
              else 
...
#line 325
                        {
                          sim_log_debug(167U, "radio_send", "Send is already being generated, cancelling this one.\n");
                        }
                    }
                }
            }
          ...
          case 2: 
            sim_log_debug_clear(168U, "radio_pack", "\t\t   Payload \n");
          sim_log_debug_clear(169U, "radio_pack", "\t\t   msg_type: ROUTE_REPLY\t msg_src: %hu\t msg_dst: %hu\t msg_value: %hu \n", __nesc_ntoh_uint16(received_msg->src.nxdata), __nesc_ntoh_uint16(received_msg->dst.nxdata), __nesc_ntoh_uint16(received_msg->value.nxdata));
...
#line 343
              ...
              if (!found || (found && __nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][i].cost.nxdata) > __nesc_ntoh_uint16(received_msg->value.nxdata))) {
                  __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][i].dst.nxdata, __nesc_ntoh_uint16(received_msg->dst.nxdata));
                  __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][i].next_hop.nxdata, __nesc_ntoh_uint16(received_msg->src.nxdata));
                  __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][i].cost.nxdata, __nesc_ntoh_uint16(received_msg->value.nxdata));


                  if (TOS_NODE_ID == 1 && __nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][i].dst.nxdata) == RadioRouteC$destination[sim_node()] && !RadioRouteC$data_sent[sim_node()]) {
                      msg = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
                      if (msg == (void *)0) {
                          return bufPtr;
                        }
                      __nesc_hton_uint8(msg->type.nxdata, 0);
                      __nesc_hton_uint16(msg->src.nxdata, TOS_NODE_ID);
                      __nesc_hton_uint16(msg->dst.nxdata, RadioRouteC$destination[sim_node()]);
...
#line 364
                        {
                          sim_log_debug(170U, "radio_send", "Send is already being generated, cancelling this one.\n");
                        }
                    }
                  else {
                      ...
                      if (RadioRouteC$locked[sim_node()] || RadioRouteC$route_rep_sent[sim_node()]) {
                          ...
                          __nesc_hton_uint16(msg->src.nxdata, TOS_NODE_ID);
                          __nesc_hton_uint16(msg->dst.nxdata, __nesc_ntoh_uint16(received_msg->dst.nxdata));
                          __nesc_hton_uint16(msg->value.nxdata, __nesc_ntoh_uint16(received_msg->value.nxdata) + 1);
                          if (RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], __nesc_ntoh_uint8(msg->type.nxdata)) == TRUE) {
                            }
                          else 
#line 384
                            {
                              sim_log_debug(171U, "radio_send", "Send is already being generated, cancelling this one.\n");
                            }
                        }
                    }
                }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7641ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7641ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7641ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb763f178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb763f178, msg, payload, len);
#line 78
...
#line 123
{
  ...
  if (err == SUCCESS) {
      ...
      if (TOS_NODE_ID == 1) {
          ...
          sim_log_debug(152U, "timer", "Timer1 started at time %s\n", sim_time_string());
        }
    }
  else {

      sim_log_error(153U, "radio", "Error in starting the radio\n");
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7641108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7641108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7488010, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7488010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7488010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77fb650){
#line 75
  switch (arg_0xb77fb650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77fb650);
#line 75
      break;
#line 75
    }
...
#line 75
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74889f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74889f8, addr, msg, len);
#line 80
...
#line 55
{
  ...
  /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
...
#line 164
        {
          sim_log_debug(154U, "radio_send", "Send is already being generated, cancelling this one.\n");
        }
    }
}
...
#line 399
{
  ...
  if (&RadioRouteC$queued_packet[sim_node()] == bufPtr && error == SUCCESS) {
      RadioRouteC$locked[sim_node()] = FALSE;
    }
  else {
      RadioRouteC$locked[sim_node()] = FALSE;
      sim_log_error(172U, "radio_send", "Send done error!");
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "RadioRouteC$destination"))
  {
    *addr = (uintptr_t)&RadioRouteC$destination[__nesc_mote];
    *size = sizeof(RadioRouteC$destination[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "RadioRouteC$j"))
  {
    *addr = (uintptr_t)&RadioRouteC$j[__nesc_mote];
    *size = sizeof(RadioRouteC$j[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  RadioRouteC$destination[__nesc_mote] = 7;
  RadioRouteC$person_code[__nesc_mote] = 0;
  RadioRouteC$j[__nesc_mote] = 0;
